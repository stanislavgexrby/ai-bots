...
Simple Telegram bot powered by Deepseek API. Maintains conversation context and responds to user messages.

## Architecture

```
core/agents/deepseek_agent.py       - Deepseek API client
core/processors/message_processor.py - Context management
interfaces/telegram/bot.py          - Telegram bot handlers
main.py                             - Entry point
```
